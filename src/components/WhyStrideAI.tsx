...
const WhyStrideAI = () => {
  ...
  return (
    <section id="why-strideai" className="section-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 mb-16">
        <div className="feature-card p-8">
          <div className="p-3 bg-stride-blue bg-opacity-10 rounded-xl w-fit mb-5">
            <Footprints className="h-8 w-8 text-stride-blue" />
          </div>
        ...
        <div className="feature-card p-8">
          <div className="p-3 bg-stride-blue bg-opacity-10 rounded-xl w-fit mb-5">
            <Brain className="h-8 w-8 text-stride-blue" />
          </div>
        ...
        <div className="feature-card p-8">
          <div className="p-3 bg-stride-blue bg-opacity-10 rounded-xl w-fit mb-5">
            <HeartPulse className="h-8 w-8 text-stride-blue" />
          </div>
      ...
      <div className="mb-16">
        <h3 className="text-2xl font-semibold mb-6 text-stride-gray-dark text-center">
              ...
              {comparisonData.map((item) => (
                <TableRow key={item.category}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div className="bg-stride-blue h-2.5 rounded-full" style={{ width: `${item.strideAI * 10}%` }}></div>
                      </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div className="bg-stride-green h-2.5 rounded-full" style={{ width: `${item.human * 10}%` }}></div>
                      </div>
          ...
          <div className="md:w-2/3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                <div className="text-2xl font-bold text-stride-blue">12 min</div>
                <div className="text-sm text-gray-500">Marathon Improvement</div>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                <div className="text-2xl font-bold text-stride-blue">15%</div>
                <div className="text-sm text-gray-500">Less Training Time</div>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                <div className="text-2xl font-bold text-stride-blue">42%</div>
                <div className="text-sm text-gray-500">Better Recovery</div>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                <div className="text-2xl font-bold text-stride-blue">0</div>
