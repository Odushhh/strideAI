      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-stride-gray-dark leading-tight">
              Your AI Running Coach, <br />Always By Your Side
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="#features" className="inline-flex items-center justify-center h-12 px-8 text-base font-medium text-stride-gray-dark border border-gray-300 rounded-full hover:bg-gray-50 transition-colors">
                Learn More
          ...
          <div className="lg:w-1/2 animate-slide-in">
            <div className="relative">
              ...
              <div className="relative border-8 border-white shadow-xl rounded-3xl overflow-hidden bg-white">
                <img 
              ...
              <div className="absolute -right-4 -bottom-4 md:right-8 md:-bottom-6 bg-white rounded-2xl shadow-lg p-4 w-40 blur-backdrop border border-white/50 transform rotate-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium">5K - 80% Complete</div>
                  </div>
                </div>
              </div>
            </div>
